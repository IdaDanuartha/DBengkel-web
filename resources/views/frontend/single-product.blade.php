...
@section('main-content')
                ...
                <div class="flex">
                  ...
                  <div class="relative">
                    <div class="flex w-24">
                        ...
                        <input type="hidden" value="{{ $product->qty }}" id="prod_qty">
        ...
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
          ...
          <div class="modal-body relative p-4">
            <form action="/add-review" method="POST" class="text-center">
              ...
              @endif
              <p class="text-xs text-gray-500 mb-3 mt-1">*Please Rating first</p>
          ...
          <div
            ...
            <button type="button"
              class="btn-effect text-sm btn-gray py-2 px-3 rounded"
              data-bs-dismiss="modal">
              Review Later
            </button>
            <button type="submit"
              class="btn-effect text-sm btn-details rounded py-2 px-3 ml-1">
              Submit
            </button>
            </form>
          </div>
  ...
  @endauth
        ...
        <div class="flex flex-col pt-24" id="all-reviews">
          ...
          <div class="body-color mb-5 w-full border-0">
            <div class="row g-0">
              <div class="col-md-4">
                <div class="flex mb-3">
                  @if($review->user->image)
                    <img class="rounded-full mr-2" width="50px" src="/assets/uploads/users/{{ $review->user->image }}" alt="">
                  @else
                    <img class="rounded-full mr-2" width="50px" src="/assets/img/user-profile.png" alt="">
                  @endif
                  <div class="flex flex-col">
                    <p class="font-medium my-light-dark-text">{{ $review->user->first_name . " " . $review->user->last_name }}</p>
              ...
              <div class="col-md-8">
                <div class="card-body relative -top-3">
                  ...
                  <p class="my-light-dark-text">{{ $review->user_review }}</p>
                </div>
              </div>
            </div>
            <hr>
