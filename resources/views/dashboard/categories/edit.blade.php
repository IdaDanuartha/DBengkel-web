                ...
                <div class="px-4 py-5 my-light-dark-text space-y-6 sm:p-6">
                  <div class="grid grid-cols-3 gap-4">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="name" id="name" autocomplete="off" class="mt-1 block w-full py-2 px-3 input-color rounded-md shadow-sm focus:outline-none focus:ring-red-400 focus:border-red-400 sm:text-sm" placeholder="Category Name" value="{{ $category->name }}">
                        @error('name')
                    ...
                    <div class="col-span-6">
                      ...
                      <div class="mt-1">
                      <textarea id="about" name="description" rows="6" class="mt-1 block w-full py-2 px-3 input-color rounded-md shadow-sm focus:outline-none focus:ring-red-400 focus:border-red-400 sm:text-sm" placeholder="Type description here...">{{ $category->description }}</textarea>
                      </div>
                      @error('description')
                          <small class="text-red-500 opacity-75">{{ $message }}</small>   
                      @enderror
                    ...
                    <div class="flex">
                      <div class="flex items-start mr-3">
                        <div class="flex items-center h-5">
                          <input id="status" name="status" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" {{ ($category->status == '1' ? 'checked' : '') }}>
                        </div>
                      ...
                      <div class="flex items-start">
                        <div class="flex items-center h-5">
                          <input id="popular" name="popular" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" {{ ($category->popular == '1' ? 'checked' : '') }}>
                        </div>
                        <div class="ml-3 text-sm">
