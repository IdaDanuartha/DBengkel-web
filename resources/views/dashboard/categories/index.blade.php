...
@section('content') 
    <a href="/dashboard/category/create" class="py-2 px-3 ml-5 bg-blue-500 text-white relative top-5"><ion-icon name="add-outline" class="relative top-0.5"></ion-icon> Create</a>
