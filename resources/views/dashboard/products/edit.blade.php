                ...
                <div class="px-4 py-5 my-light-dark-text space-y-12 sm:p-6">
                  <div class="grid grid-cols-6 gap-4">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input type="number" name="ori_price" id="ori_price" autocomplete="off" class="mt-1 block w-full py-2 px-3 rounded-md shadow-sm focus:outline-none focus:ring-red-400 focus:border-red-400 sm:text-sm input-color" placeholder="Ex: 45000" value="{{ $product->ori_price }}">
                      @error('ori_price')
                          <small class="text-red-500 opacity-75">{{ $message }}</small>   
                      @enderror
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input type="number" name="disc_price" id="disc_price" autocomplete="off" class="mt-1 block w-full py-2 px-3 rounded-md shadow-sm focus:outline-none focus:ring-red-400 focus:border-red-400 sm:text-sm input-color" placeholder="Ex: 35000" value="{{ $product->disc_price }}">
                      @error('disc_price')
                          <small class="text-red-500 opacity-75">{{ $message }}</small>   
                      @enderror
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input type="number" name="quantity" id="quantity" autocomplete="off" class="mt-1 block w-full py-2 px-3 rounded-md shadow-sm focus:outline-none focus:ring-red-400 focus:border-red-400 sm:text-sm input-color" placeholder="Ex: 67" value="{{ $product->quantity }}">
                      @error('quantity')
                          <small class="text-red-500 opacity-75">{{ $message }}</small>   
                      @enderror
                    </div>
